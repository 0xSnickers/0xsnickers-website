          ...
          <div className="flex items-center gap-3">
            {visibleSocials.map((social) => (
              <a
                ...
                className="flex h-10 w-10 items-center justify-center rounded-xl border border-border/50 bg-white/80 text-text/70 transition-all hover:-translate-y-1 hover:text-primary hover:border-primary/20 hover:bg-primary/5"
